...
private class Airport {
    ...
    private List<PassengerPlane> getPasPl() {
    ...
    private PassengerPlane getPassengerPlaneWithMaxPassengersCapacity() {
    ...
    private List<MilitaryPlane> getTransportMilitaryPlanes() {
    ...
    private List<experimentalPlane> getExperimentalPlanes() {
    ...
    private Airport sortByMaxDistance() {
        Collections.sort(planes, new Comparator<Plane>() {
            private int compare(Plane o1, Plane o2) {
     ...
     * @return Airport
     */
    private Airport sortByMaxSpeed() {
        Collections.sort(planes, new Comparator<Plane>() {
            private int compare(Plane o1, Plane o2) {
    ...
    private Airport sortByMaxLoadCapacity() {
        Collections.sort(planes, new Comparator<Plane>() {
            private int compare(Plane o1, Plane o2) {
    ...
    private List<? extends Plane> getPlanes() {
        return planes;
    }
    ...
    //Constructor
    private Airport(List<? extends Plane> planes) {
        this.planes = planes;
    }
